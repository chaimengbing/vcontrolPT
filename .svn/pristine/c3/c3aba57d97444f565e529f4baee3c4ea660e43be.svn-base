...
public class ImageLoader
{
     ...
     * @param imageView
     */
    public void loadImage(final String path, FTPFile remoteFile,final ImageView imageView,
                          final boolean isFromNet)
    {
        ...
        {
            addTask(buildTask(path, remoteFile,imageView, isFromNet));
        }
     ...
     * @return
     */
    private Runnable buildTask(final String path, final FTPFile remoteFile, final ImageView imageView,
                               final boolean isFromNet)
    {
        return new Runnable()
        {
...
//									.downloadImgByUrl(path, file);
                            boolean downloadState = FTPManager.getFtpManager().downloadImgByUrl(path, remoteFile, file);
...
//									imageView);
                            bm = FTPManager.getFtpManager().downloadImgByUrl(path, remoteFile,
                                    imageView);
                        }
                    }
                }
