package com.vcontrol.vcontroliot.service;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.BitmapFactory;

import com.vcontrol.vcontroliot.callback.PBase;
import com.vcontrol.vcontroliot.log.Log;
import com.vcontrol.vcontroliot.model.AdMessageBean;
import com.vcontrol.vcontroliot.model.AdModelImpl;
import com.vcontrol.vcontroliot.model.LoginCheckBean;
import com.vcontrol.vcontroliot.util.AdContract;
import com.vcontrol.vcontroliot.util.RxSubscribe;
...
public class AdPresenterImpl extends PBase<AdContract.View>
{
    ...
    private boolean writeResponseBodyToDisk(ResponseBody body, String fileName, String fileUrl) {//保存图片到本地
        try {
            ...
            Log.d("文件的保存地址为：" + ((Context) getMyView()).getExternalFilesDir(null) + File.separator + fileName);
            ...
            try {
                ...
                while (true) {
                    ...
                    Log.d("file download: " + fileSizeDownloaded / fileSize * 100);
