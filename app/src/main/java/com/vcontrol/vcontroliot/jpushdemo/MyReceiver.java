...
//			context.startActivity(intent1);
			if (ClientFragment.layoutThree != null & ClientFragment.layoutFour != null)
			{
				if (ClientFragment.layoutThree.getVisibility() == View.GONE)
				{
					ClientFragment.layoutThree.setVisibility(View.VISIBLE);
					ClientFragment.layoutFour.setVisibility(View.GONE);
				}
				else if (ClientFragment.layoutFour.getVisibility() == View.GONE)
				{
					ClientFragment.layoutFour.setVisibility(View.VISIBLE);
					ClientFragment.layoutThree.setVisibility(View.GONE);
				}
			}
			TipButton.mTipOn = true;
